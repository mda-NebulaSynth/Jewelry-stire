        ...
        <main style={{ flex: 1 }}>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/offers" element={<div className="container" style={{ padding: '3rem' }}><h1>Offers - Coming Soon</h1></div>} />
              <Route path="/about" element={<div className="container" style={{ padding: '3rem' }}><h1>About - Coming Soon</h1></div>} />
              ...
              <Route path="/login" element={<div className="container" style={{ padding: '3rem' }}><h1>Login - Coming Soon</h1></div>} />
              <Route path="/checkout" element={<div className="container" style={{ padding: '3rem' }}><h1>Checkout - Coming Soon</h1></div>} />
